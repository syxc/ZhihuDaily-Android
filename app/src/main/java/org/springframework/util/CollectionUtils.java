...
public abstract class CollectionUtils {
   ...
   */
  @SuppressWarnings("rawtypes") public static List arrayToList(Object source) {
   ...
   */
  @SuppressWarnings("unchecked") public static <E> void mergeArrayIntoCollection(Object array,
   ...
   */
  @SuppressWarnings("unchecked") public static <K, V> void mergePropertiesIntoMap(Properties props,
      Map<K, V> map) {
    if (map == null) {
   ...
   */
  @SuppressWarnings("unchecked") public static <E> E findFirstMatch(Collection<?> source,
   ...
   */
  @SuppressWarnings("unchecked") public static <T> T findValueOfType(Collection<?> collection,
      Class<T> type) {
   ...
   * @since 3.1
   */
  @SuppressWarnings("unchecked") public static <K, V> MultiValueMap<K, V> unmodifiableMultiValueMap(
   ...
   */
  @SuppressWarnings("serial") private static class MultiValueMapAdapter<K, V>
    ...
    @Override public void putAll(Map<? extends K, ? extends List<V>> map) {
      this.map.putAll(map);
    }
