...
public abstract class ObjectUtils {
   ...
   * @since 4.2
   */
  @SuppressWarnings("rawtypes") public static boolean isEmpty(Object obj) {
    if (obj == null) {
      return true;
    }
   ...
   * of enum values. Use {@link #containsConstant(Enum[], String)} as a guard to avoid this
   * exception.
   */
  public static <E extends Enum<?>> E caseInsensitiveValueOf(E[] enumValues, String constant) {
    ...
    throw new IllegalArgumentException(
        String.format("constant [%s] does not exist in enum type %s", constant,
